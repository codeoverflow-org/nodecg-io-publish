...
module.exports = function (nodecg) {
    ...
    const debug = (0, nodecg_io_core_1.requireService)(nodecg, "debug");
    debug === null || debug === void 0 ? void 0 : debug.onAvailable((debug) => {
    ...
    debug === null || debug === void 0 ? void 0 : debug.onUnavailable(() => {
